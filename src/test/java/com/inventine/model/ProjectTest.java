...
class ProjectTest {
    ...
    void getterSetter(String project_id, String creator_id, String support_team_id, Timestamp created_at, char financial_status, char status, int requested_amount, Timestamp date_of_expiry, String project_name, String details, String category) {
