        ...
        <div class = "project-content">
                ...
                <div class="row">
                    ...
                    <div class="column">
                        <div class="card">
                            ...
                            <div class="count"><% out.print(request.getAttribute("daysleft"));%></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="creator-info">
                ...
                <div class="creator-link">
                    <p>By: <a><b style="text-transform: capitalize"><% out.print(user.getFirstName());%> <% out.print(user.getLastName());%></b></a></p>
                </div>
            </div>
...
<%--            <img class="dt-img" src = "https://picsum.photos/400/400/?image=1071" alt = "shoe image">--%>
            ...
            <%out.print(new String(project.getDescription()));%>
        </div>
