...
<nav>
  <ul class="menu">
    <li class="logo"><a href="${System.getenv("HOST_URL")}">inventine</a></li>
    ...
    <li class="item button"><a href="${System.getenv("HOST_URL")}/login">Log In</a></li>
    <li class="item button secondary"><a href="${System.getenv("HOST_URL")}/signup">Sign Up</a></li>
